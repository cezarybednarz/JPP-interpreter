...
Stmt : ';' { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), Chococino.Abs.Empty (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1))) }
     ...
     | Type Ident '[' Expr ']' { (fst $1, Chococino.Abs.ArrDecl (fst $1) (snd $1) (snd $2) (snd $4)) }
     | Ident '=' Expr ';' { (fst $1, Chococino.Abs.Ass (fst $1) (snd $1) (snd $3)) }
     | Ident '[' Expr ']' '=' Expr { (fst $1, Chococino.Abs.ArrAss (fst $1) (snd $1) (snd $3) (snd $6)) }
     | TupL '=' TupR { (fst $1, Chococino.Abs.TupleAss (fst $1) (snd $1) (snd $3)) }
     ...
     | 'if' '(' Expr ')' Stmt { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), Chococino.Abs.Cond (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1)) (snd $3) (snd $5)) }
     | 'if' '(' Expr ')' Stmt 'else' Stmt { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), Chococino.Abs.CondElse (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1)) (snd $3) (snd $5) (snd $7)) }
...
Type : 'int' { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), Chococino.Abs.Int (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1))) }
     ...
     | 'tuple' { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), Chococino.Abs.Tuple (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1))) }
...
Expr6 : Ident { (fst $1, Chococino.Abs.EVar (fst $1) (snd $1)) }
      ...
      | TupR { (fst $1, Chococino.Abs.ELitTuple (fst $1) (snd $1)) }
      | Lambda { (fst $1, Chococino.Abs.ELitLambd (fst $1) (snd $1)) }
      ...
      | Ident '[' Expr ']' { (fst $1, Chococino.Abs.EArr (fst $1) (snd $1) (snd $3)) }
...
TupL :: { (Chococino.Abs.BNFC'Position, Chococino.Abs.TupL) }
TupL : Ident { (fst $1, Chococino.Abs.TupLId (fst $1) (snd $1)) }
     | '(' ListTupL ')' { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), Chococino.Abs.TupLPar (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1)) (snd $2)) }
     | TupL1 { (fst $1, (snd $1)) }

TupL1 :: { (Chococino.Abs.BNFC'Position, Chococino.Abs.TupL) }
TupL1 : '(' TupL ')' { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), (snd $2)) }

ListTupL :: { (Chococino.Abs.BNFC'Position, [Chococino.Abs.TupL]) }
ListTupL : {- empty -} { (Chococino.Abs.BNFC'NoPosition, []) }
         | TupL { (fst $1, (:[]) (snd $1)) }
         | TupL ',' ListTupL { (fst $1, (:) (snd $1) (snd $3)) }

TupR :: { (Chococino.Abs.BNFC'Position, Chococino.Abs.TupR) }
TupR : Expr { (fst $1, Chococino.Abs.TupRExpr (fst $1) (snd $1)) }
     | '(' ListTupR ')' { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), Chococino.Abs.TupRPar (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1)) (snd $2)) }
     | TupR1 { (fst $1, (snd $1)) }

TupR1 :: { (Chococino.Abs.BNFC'Position, Chococino.Abs.TupR) }
TupR1 : '(' TupR ')' { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), (snd $2)) }

ListTupR :: { (Chococino.Abs.BNFC'Position, [Chococino.Abs.TupR]) }
ListTupR : {- empty -} { (Chococino.Abs.BNFC'NoPosition, []) }
         | TupR { (fst $1, (:[]) (snd $1)) }
         | TupR ',' ListTupR { (fst $1, (:) (snd $1) (snd $3)) }

LArg :: { (Chococino.Abs.BNFC'Position, Chococino.Abs.LArg) }
LArg : Type Ident { (fst $1, Chococino.Abs.LambdaArg (fst $1) (snd $1) (snd $2)) }
     | LArg1 { (fst $1, (snd $1)) }

LArg1 :: { (Chococino.Abs.BNFC'Position, Chococino.Abs.LArg) }
LArg1 : '(' LArg ')' { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), (snd $2)) }

ListLArg :: { (Chococino.Abs.BNFC'Position, [Chococino.Abs.LArg]) }
ListLArg : {- empty -} { (Chococino.Abs.BNFC'NoPosition, []) }
         | LArg { (fst $1, (:[]) (snd $1)) }
         | LArg ',' ListLArg { (fst $1, (:) (snd $1) (snd $3)) }

Lambda :: { (Chococino.Abs.BNFC'Position, Chococino.Abs.Lambda) }
Lambda : Ident { (fst $1, Chococino.Abs.LambdaId (fst $1) (snd $1)) }
       | '(' ListLArg ')' '->' Block { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), Chococino.Abs.LambdaDef (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $5)) }
       | Lambda1 { (fst $1, (snd $1)) }

Lambda1 :: { (Chococino.Abs.BNFC'Position, Chococino.Abs.Lambda) }
Lambda1 : '(' Lambda ')' { (uncurry Chococino.Abs.BNFC'Position (tokenLineCol $1), (snd $2)) }

ListLambda :: { (Chococino.Abs.BNFC'Position, [Chococino.Abs.Lambda]) }
ListLambda : {- empty -} { (Chococino.Abs.BNFC'NoPosition, []) }
           | Lambda { (fst $1, (:[]) (snd $1)) }
           | Lambda ',' ListLambda { (fst $1, (:) (snd $1) (snd $3)) }
