...
transStmt x = case x of
  ...
  Chococino.Abs.ArrDecl _ type_ ident expr -> failure x
  Chococino.Abs.Ass _ ident expr -> failure x
  Chococino.Abs.ArrAss _ ident expr1 expr2 -> failure x
  Chococino.Abs.TupleAss _ tupl tupr -> failure x
  ...
  Chococino.Abs.Cond _ expr stmt -> failure x
  Chococino.Abs.CondElse _ expr stmt1 stmt2 -> failure x
...
transType x = case x of
  ...
  Chococino.Abs.Tuple _ -> failure x
...
transExpr x = case x of
  ...
  Chococino.Abs.ELitTuple _ tupr -> failure x
  Chococino.Abs.ELitLambd _ lambda -> failure x
  ...
  Chococino.Abs.EArr _ ident expr -> failure x
...
transTupL :: Show a => Chococino.Abs.TupL' a -> Result
transTupL x = case x of
  Chococino.Abs.TupLId _ ident -> failure x
  Chococino.Abs.TupLPar _ tupls -> failure x

transTupR :: Show a => Chococino.Abs.TupR' a -> Result
transTupR x = case x of
  Chococino.Abs.TupRExpr _ expr -> failure x
  Chococino.Abs.TupRPar _ tuprs -> failure x

transLArg :: Show a => Chococino.Abs.LArg' a -> Result
transLArg x = case x of
  Chococino.Abs.LambdaArg _ type_ ident -> failure x

transLambda :: Show a => Chococino.Abs.Lambda' a -> Result
transLambda x = case x of
  Chococino.Abs.LambdaId _ ident -> failure x
  Chococino.Abs.LambdaDef _ largs block -> failure x
